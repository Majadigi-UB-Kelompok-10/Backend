TRUNCATE TABLE tarif_pkb, master_njkb, kendaraan_pajak RESTART IDENTITY CASCADE;
...
-- B. Data Kalkulator NJKB (Dropdown Master)
...
-- C. Data Tagihan Pajak Kendaraan (Untuk endpoint Cek Pajak)
...
('N1234AB', 'N 1234 AB', 'MHK12345', true, 'HONDA', 'VARIO', '125 CBS', 'HITAM', 2022, '2026-05-10', 225000, 150000, 35000, 20000, 0, 0),
('N5678CD', 'N 5678 CD', 'MHY56789', true, 'YAMAHA', 'NMAX', '155 ABS', 'BIRU', 2023, '2028-08-17', 360000, 240000, 35000, 20000, 100000, 60000),
('N9999ZZ', 'N 9999 ZZ', 'MHT99999', false, 'TOYOTA', 'AVANZA', '1.5 G MT', 'PUTIH', 2023, '2024-01-01', 2325000, 1550000, 143000, 40000, 0, 0),
('L1111AA', 'L 1111 AA', 'MHB11111', true, 'HONDA', 'BRIO', 'SATYA E CVT', 'MERAH', 2022, '2026-11-20', 1650000, 1100000, 143000, 40000, 0, 0);