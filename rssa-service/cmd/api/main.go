...
func loadConfig() (*Config, error) {
	cfg := &Config{
		...
		ServicePublic: getEnv("SERVICE_PUBLIC_URL", "http://rssa-api:8080/api/v1"),
...
// =============================================================================
// LOGGER — service metadata baked into every log line
// =============================================================================
...
// =============================================================================
// DATABASE POOL — with smart tracer
// =============================================================================
func newDBPool(ctx context.Context, cfg *Config) (*pgxpool.Pool, error) {
	...
	// Verifikasi koneksi di startup — fail fast
...
func initializeCache(cfg *Config) error {
	if cfg.RedisURL == "" {
		slog.Warn("REDIS_URL kosong, fallback ke SimpleCache (in-memory) — tidak direkomendasikan untuk produksi multi-replica")
		return nil
	}
...
func globalErrorHandler(cfg *Config) fiber.ErrorHandler {
	return func(c fiber.Ctx, err error) error {
		...
		// Jangan bocorkan error internal di production
		message := "Terjadi kesalahan pada server RSSA"
...
// =============================================================================
// GRACEFUL SHUTDOWN — urutan: HTTP → cache → DB
// =============================================================================
