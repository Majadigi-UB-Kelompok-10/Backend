...
func loadConfig() (*Config, error) {
	cfg := &Config{
		...
		ServicePublic: getEnv("SERVICE_PUBLIC_URL", "http://sidita-api:8080/api/v1"),
...
func main() {
	...
	go func() {
		registry.AutoRegister(cfg.GatewayDBURL, "sidita", cfg.ServicePublic)
...
func globalErrorHandler(cfg *Config) fiber.ErrorHandler {
	return func(c fiber.Ctx, err error) error {
		...
		message := "Terjadi kesalahan pada server Sidita"
